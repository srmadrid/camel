 ...
 * @return Status code.
 */
CML_Status cml_matrixU32_add(CML_Allocator *allocator, const CML_Matrix *left, const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixU32_sub(CML_Allocator *allocator, const CML_Matrix *left, const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixU32_sub_inplace(const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixU32_multew_inplace(const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixU32_divew(CML_Allocator *allocator, const CML_Matrix *left, const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixU32_divew_inplace(const CML_Matrix *right, CML_Matrix *out);
 ...
 *
 * @return Status code. */
CML_Status cml_matrixU32_print(CML_Allocator *allocator, const CML_Matrix *matrix);
