 ...
 * @file mI16.h
 * 
 * @brief Declaration of i16's type specific matrix functions.
 *
 ...
 * @return Status code.
 */
CML_Status cml_matrixI16_set(i16 element, u32 row, u32 column, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixI16_add(CML_Allocator *allocator, const CML_Matrix *left, const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixI16_add_inplace(const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixI16_sub(CML_Allocator *allocator, const CML_Matrix *left, const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixI16_sub_inplace(const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixI16_mult(CML_Allocator *allocator, const CML_Matrix *left, const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixI16_divew(CML_Allocator *allocator, const CML_Matrix *left, const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixI16_transpose(CML_Allocator *allocator, const CML_Matrix *A, CML_Matrix *out);
 ...
 *
 * @return Status code. */
CML_Status cml_matrixI16_print(CML_Allocator *allocator, const CML_Matrix *matrix);
