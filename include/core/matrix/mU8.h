 ...
 * @return Status code.
 */
CML_Status cml_matrixU8_multew(CML_Allocator *allocator, const CML_Matrix *left, const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixU8_divew_inplace(const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixU8_transpose(CML_Allocator *allocator, const CML_Matrix *A, CML_Matrix *out);
 ...
 *
 * @return Status code. */
CML_Status cml_matrixU8_print(CML_Allocator *allocator, const CML_Matrix *matrix);
