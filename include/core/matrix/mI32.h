 ...
 * @file mI32.h
 * 
 * @brief Declaration of i32's type specific matrix functions.
 *
 ...
 * @return Status code.
 */
CML_Status cml_matrixI32_set(i32 element, u32 row, u32 column, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixI32_add_inplace(const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixI32_sub(CML_Allocator *allocator, const CML_Matrix *left, const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixI32_sub_inplace(const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixI32_mult(CML_Allocator *allocator, const CML_Matrix *left, const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixI32_multew(CML_Allocator *allocator, const CML_Matrix *left, const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixI32_multew_inplace(const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixI32_divew(CML_Allocator *allocator, const CML_Matrix *left, const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixI32_divew_inplace(const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixI32_transpose(CML_Allocator *allocator, const CML_Matrix *A, CML_Matrix *out);
