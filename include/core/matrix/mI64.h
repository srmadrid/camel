 ...
 * @return Status code.
 */
CML_Status cml_matrixI64_sub_inplace(const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixI64_mult(CML_Allocator *allocator, const CML_Matrix *left, const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixI64_multew(CML_Allocator *allocator, const CML_Matrix *left, const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixI64_multew_inplace(const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixI64_divew_inplace(const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixI64_transpose(CML_Allocator *allocator, const CML_Matrix *A, CML_Matrix *out);
 ...
 *
 * @return Status code. */
CML_Status cml_matrixI64_print(CML_Allocator *allocator, const CML_Matrix *matrix);
