 ...
 * @return Status code.
 */
CML_Status cml_matrixCMPLX_divew_inplace(const CML_Matrix *right, CML_Matrix *out);
 ...
 *
 * @return Status code. */
CML_Status cml_matrixCMPLX_print(CML_Allocator *allocator, const CML_Matrix *matrix);
