 ...
 * @file mCF32.h
 * 
 * @brief Declaration of cf32's type specific matrix functions.
 *
 ...
 * @return Status code.
 */
CML_Status cml_matrixCF32_set(cf32 element, u32 row, u32 column, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixCF32_add(CML_Allocator *allocator, const CML_Matrix *left, const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixCF32_multew(CML_Allocator *allocator, const CML_Matrix *left, const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixCF32_transpose(CML_Allocator *allocator, const CML_Matrix *A, CML_Matrix *out);
