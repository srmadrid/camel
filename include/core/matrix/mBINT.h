 ...
 * @file mBINT.h
 * 
 * @brief Declaration of BigInt's type specific matrix functions.
 *
 ...
 * @return Status code.
 */
CML_Status cml_matrixBINT_add(CML_Allocator *allocator, const CML_Matrix *left, const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixBINT_multew(CML_Allocator *allocator, const CML_Matrix *left, const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixBINT_multew_inplace(const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixBINT_divew_inplace(const CML_Matrix *right, CML_Matrix *out);
 ...
 * @return Status code.
 */
CML_Status cml_matrixBINT_transpose(CML_Allocator *allocator, const CML_Matrix *A, CML_Matrix *out);
 ...
 *
 * @return Status code. */
CML_Status cml_matrixBINT_print(CML_Allocator *allocator, const CML_Matrix *matrix);
