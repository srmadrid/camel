/** @file cml_matrixCF64_sub_inplace.c
 * 
 * @brief In-place subtract function for matrices holding cf64's.
 *
...
CML_Status cml_matrixCF64_sub_inplace(const CML_Matrix *right, CML_Matrix *out) {
