/** @file cml_matrixCF64_add_inplace.c
 * 
 * @brief In-place add function for matrices holding cf64's.
 *
...
CML_Status cml_matrixCF64_add_inplace(const CML_Matrix *right, CML_Matrix *out) {
