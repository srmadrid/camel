...
ifeq ($(OS),Linux)
    ...
    EXT = so
    CFLAGS = -pedantic -Wall -Wextra -Werror -Iinclude -fopenmp -fPIC -msse3 -fsanitize=address,undefined -pedantic-errors -g -O3 -march=native -ffast-math #(to debug if something like a segfault occurs)
